...
public class TextAdventure extends PlayerAndNavigate{

	public static void main(String[] args) {

		TextAdventure dublin;
		dublin = new TextAdventure();
		dublin.playerSetUp();
                dublin.townGate();
	}
}

class PlayerAndNavigate{
...
class Alternate{
        PlayerAndNavigate Pv = new PlayerAndNavigate();
    	public void dead() {
		System.out.println("\n------------------------------------------------------------------\n");
	...
	public void win() {
		...
		Pv.choice = Pv.myScanner.nextInt();
		if (Pv.choice == 1) {
			Pv.crossRoad();
		} else {
			win();
